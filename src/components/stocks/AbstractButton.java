 ...
 * JDialog by request.
 */
public abstract class AbstractButton extends JPanel implements ActionListener, FontInterface, KeyListener {
    // instance variables.
    ...
    protected JLabel listHeading, searchLabel;
     ...
     */
    public AbstractButton(int haveDeleteOption, JDialog dataViewer) {
        // set JDialog reference.
        this.dataViewer = dataViewer;
        // create the buttons.
        createButtons(haveDeleteOption);
     ...
     * 
     * @param haveDeleteOption
     */
    private void createButtons(int haveDeleteOption) {
    ...
    protected void createViewer(EmployeeView view, SizeView view1, GuageRateView view2) {
        ...
        String headLabel = "Employee List", searchL = "Search by Name :";
        int col = 20;

        if (view1 != null) {
            headLabel = "Size List";
            searchL = "Search by Size :";
            col = 10;
        } else if (view2 != null) {
            headLabel = "Guage-Rate List";
            searchL = "Search by Guage or Rate :";
            col = 15;
        }
        ...
        // create search label
        searchLabel = new JLabel(searchL);
        searchLabel.setFont(labelFont);

        // create search field
        searchField = new JTextField(col);
        searchField.setFont(fieldFont);

        // add labels and field to the heading panel.
        dataViewHeadingPanel.add(listHeading);
        dataViewHeadingPanel.add(searchLabel);
        dataViewHeadingPanel.add(searchField);
