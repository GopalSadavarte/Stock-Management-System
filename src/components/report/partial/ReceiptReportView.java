 ...
 * 
 * 
 * This component have an receipt data in tabular format.
 * 
 * 
 */
...
/**
 * The class ReceiptReportView are contains the report data in tabular format.
 */
public class ReceiptReportView extends JPanel implements FontInterface {
    ...
    /**
     * A constructor are create an table with receipt data from DB.
     */
    ...
    private void addDataIntoTable() {
        try {
            ...
            String query = "SELECT * FROM vouchers WHERE status = 'Received'";
